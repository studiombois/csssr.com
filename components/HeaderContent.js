      ...
      <Fragment>
          ...
          <div className="grid-container header-content">
              ...
              <span className="logo-wrapper">
                <Link href={isJob ? jobsRootUrl : rootUrl}>
                  <a data-testid="header:link:logo">
                    ...
                    {logoSup && <sup className="font_roboto-slab-light">{logoSup}</sup>}
                  </a>
                </Link>
              </span>
            ) : (
                ...
                {links.map(({ href, label, scrollToFormName, hideOnTablet, testid }) => (
                  <li
                    className={`nav-list-item${
                      hideOnTablet ? ' nav-list-item_hide-on-tablet' : ''
                    }`}
            ...
            {isBurgerVisible && (
              <button
                ...
                data-testid="header:button:openSideBar"
              >
                {burgerIcon}
              </button>
            )}
        ...
        <style jsx>{`
          ...
          .header-background {
            ...
            z-index: 9999;
            width: 100%;
            padding-right: ${!pinHeader && showHeader && isSideBarOpened
              ? scrollbarWidth + 'px'
              : '0'};
          }
