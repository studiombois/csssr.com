...
const Footer = ({ router: { pathname }, socialLinks = allSocialLinks, className, lng, t }) => {
  ...
  return (
    <footer className={`${className} grid-container`}>
      {pathname === rootUrl ? (
      ...
      <ul className="social-links">
        {socialLinks.map(({ href, label }) => (
          <li key={label} className="social-link">
            <a aria-label={`${label} link`} href={href} target="_blank" rel="noopener">
              <img
      ...
      <ul className="footer-links">
        ...
        <li className="footer-link">
          <span
            className="font_footer-text"
            dangerouslySetInnerHTML={{ __html: t('common:footer.alliancePartText') }}
          />{' '}
          <a
