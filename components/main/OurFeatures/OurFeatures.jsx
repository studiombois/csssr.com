  ...
  return (
    ...
    >
      <SubHeading
        ...
        as="p"
        type="slab"
        dangerouslySetInnerHTML={{ __html: translations.main.ourFeatures.feature1.text }}
      />
      <Link
        className="link"
        ...
        type="list"
        size="m"
        dangerouslySetInnerHTML={{ __html: translations.main.ourFeatures.feature1.link }}
      ...
      <Text
        ...
        type="strong"
        size="m"
        dangerouslySetInnerHTML={{ __html: translations.main.ourFeatures.feature2.text }}
      />
      <Link
        className="link"
        ...
        type="list"
        size="m"
        dangerouslySetInnerHTML={{ __html: translations.main.ourFeatures.feature2.link }}
