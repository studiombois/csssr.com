...
class Slider extends PureComponent {
  ...
  render() {
    ...
    const { activeSlide } = this.state
    const slideTitle = translations.dev.portfolio.projects[id].title
      ...
      <section className={className}>
        <div className="slider">
          ...
          >
            {slides.map((slide) => (
              <img
                ...
                `}
                alt={`${translations.dev.portfolio.slidesAlt}${slideTitle}`}
          ...
          <div className="controls">
            <button
              name="previous-slide"
              aria-label={translations.dev.portfolio.previousSlide}
            ...
            <button
              name="next-slide"
              aria-label={translations.dev.portfolio.nextSlide}
          ...
          {href && (
            <a
              ...
              aria-label={`${translations.dev.portfolio.openSlide} ${slideTitle}`}
            >
        ...
        <h4
          ...
          dangerouslySetInnerHTML={{
            __html: translations.dev.portfolio.projects[id].title,
          }}
        />
        <p
          className="font_p16-regular"
          dangerouslySetInnerHTML={{
            __html: translations.dev.portfolio.projects[id].text,
          }}
        />
      </section>
    )
...
export default styled(L10nConsumer(Slider))`
  ${styles}
`
