...
const Cups = ({ t }) =>
  <Fragment>
    <section className='grid-container' id='manifest'>
      ...
      />
      <PictureForAllResolutions
        className={pictureBig.className}
        image={{ namespace: 'school', key: 'cup4', alt: t('school:imgAlt.school') }}
      />
      <PictureForAllResolutions
        className={picture.className}
        image={{ namespace: 'school', key: 'cup5', alt: t('school:imgAlt.school') }}
      />
