...
export default {
  menu: [
    ...
    {
      id: 'portfolio',
      title: (t) => t.common.header.menu.portfolio.title,
      links: [
        {
          id: 'ourProjects',
          icon: OurProjects,
          title: (t) => t.common.header.menu.portfolio.ourProjects.title,
          description: (t) => t.common.header.menu.portfolio.ourProjects.description,
          href: 'projects',
        },
        {
          id: 'mediaAndMarketing',
          icon: Message,
          heading: (t) => t.common.header.menu.portfolio.mediaAndMarketing.heading,
        ...
        },
        {
          id: 'eCommerce',
          icon: Bag,
          title: (t) => t.common.header.menu.portfolio.eCommerce.title,
          href: 'industry/ecommerce',
        },
        {
          id: 'information',
          icon: Computer,
          title: (t) => t.common.header.menu.portfolio.information.title,
          href: 'industry/information-technology',
        },
        {
          id: 'fintech',
          icon: PieChart,
          title: (t) => t.common.header.menu.portfolio.fintech.title,
