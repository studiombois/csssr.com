export default {
  ...
  techList: [
    {
      name: 'project:gazpromNeft.techStack.techList.firstItem',
    },
    {
      name: 'project:gazpromNeft.techStack.techList.secondItem',
    },
    {
      name: 'project:gazpromNeft.techStack.techList.thirdItem',
    },
  ],
  numericData: {
    duration: {
