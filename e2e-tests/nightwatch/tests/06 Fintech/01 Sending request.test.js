...
testcase('Send request from header modal form of RU-locales - Fintech', () => {
...
testcase(
  'Send request via the button in the first block of RU-locales - Fintech',
  () => {
    step('Go to the Fintech industry page', () => {
      browser
        .setWindowSize(1360, 1024)
...
testcase('Sending request from the form at the end of the page of RU-locales - Fintech', () => {
...
testcase('Send request from header modal form of EN-locales - Fintech', () => {
  step('Go to the Fintech industry page', () => {
    browser
      .setWindowSize(1360, 1024)
...
testcase(
  'Send request via the button in the first block of EN-locales - Fintech',
  () => {
    step('Go to the Fintech industry page', () => {
...
testcase('Sending request from the form at the end of the page of EN-locales - Fintech', () => {
  step('Go to the form at the end of the page', () => {
    browser.url(browser.launch_url + '/en/industry/fintech')
  })
