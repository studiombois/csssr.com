!(function () {
  const loc = window.location.href.match('(/en/|/en+$)') ? 'en' : 'ru',
    CONTENT = {
      ru: {
  ...
  ;(styles.rel = 'stylesheet'), (styles.href = '/modal/modal.min.css')
  ...
  ;(modal.className = 'modal-browser'),
    modal.addEventListener('click', function (event) {
      ;('modal-browser__wrapper' !== event.target.className &&
        'modal-browser__close-image' !== event.target.className &&
        'modal-browser__close' !== event.target.className) ||
